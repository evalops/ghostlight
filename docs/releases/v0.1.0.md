...
The release has receipts for two synthetic Chromium tabs, a cookie, and local storage surviving a Compose recreation. The native app also reloaded its saved viewer URL after quitting and reopening. Bounded live recovery and explicitly witnessed real-account persistence remain pending. Elapsed calendar days are not an acceptance gate.
