...
| `golang.org/x/crypto` 0.52.0, `x/net` 0.55.0, `x/sys` 0.45.0, and `x/text` 0.39.0 | Patched Neko server dependencies. | BSD-3-Clause. | [`x/crypto` LICENSE](https://go.googlesource.com/crypto/+/refs/tags/v0.52.0/LICENSE), [`x/net` LICENSE](https://go.googlesource.com/net/+/refs/tags/v0.55.0/LICENSE), [`x/sys` LICENSE](https://go.googlesource.com/sys/+/refs/tags/v0.45.0/LICENSE), [`x/text` LICENSE](https://go.googlesource.com/text/+/refs/tags/v0.39.0/LICENSE) |
